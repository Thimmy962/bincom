-- SQLite does not support SET SQL_MODE
-- Also, SQLite does not have the concept of AUTO_INCREMENT, so we use INTEGER PRIMARY KEY instead
-- There is no need for charset specifications in SQLite
...
-- Add other table structures and data as needed


CREATE TABLE IF NOT EXISTS `announced_pu_results` (
    `result_id` INTEGER PRIMARY KEY AUTOINCREMENT,
    `polling_unit_uniqueid` TEXT,
...
-- Insert data into table `polling_unit`
